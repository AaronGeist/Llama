...
class Crawler(Login):
    ...
    def parse_lvl_one(cls):
        ...
        url = "http://www.90mh.com/manhua/%s/" % cls.book_id
        retry = 0
        while True:
        ...
        links = HttpUtils.get_attrs(resp, "#chapter-list-10 li a", "href")

        titles = HttpUtils.get_contents(resp, "#chapter-list-10 li a span")
